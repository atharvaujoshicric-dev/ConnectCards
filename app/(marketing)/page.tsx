...
import { PaperVsConnectStory } from '@/components/marketing/paper-vs-connect-story';
...
export default function LandingPage() {
  return (
    <>
      ...
      {/* Chapter 2: the problem, shown rather than told */}
      <Reveal>
        <section className="border-y border-border/60 bg-secondary/20 py-20">
          <div className="container">
            <p className="text-center font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">
              Same introduction, two outcomes
            </p>
            <h2 className="mx-auto mt-3 max-w-xl text-balance text-center font-display text-3xl font-semibold tracking-tight">
              One gets thrown away. One gets tapped.
            </h2>
            <div className="mt-16">
              <PaperVsConnectStory />
            </div>
      ...
      {/* Chapter 4: how the story continues after the tap — pinned scrollytelling */}
      <ScrollStory />
